...
for number_of_users in [100, 300, 500, 750, 1000]:
    ...
    if os.path.exists(str('Data/assignment' + name + '.p')):
        ...
        for iteration in range(iteration_min, iteration_max):
            ...
            capacity = f.find_capacity_per_user(opt_x, x_user, y_user)
    ...
    find_data.main(optimal, shares,  xs, ys, capacities, GreedyHeuristic = GreedyHeuristic, GreedyRate = GreedyRate)