...
grid_1bs = np.add(grid_1bs_1, grid_1bs_2)
grid_2mc = np.add(grid_2mc_1, grid_2mc_2)
grid_3mc = np.add(grid_3mc_1, grid_3mc_2)
grid_4mc = np.add(grid_4mc_1, grid_4mc_2)
grid_5mc = np.add(grid_5mc_1, grid_5mc_2)
